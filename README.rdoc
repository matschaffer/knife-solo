...
The knife command for creating encrypted data bags doesn't work well without a Chef server, so use this gist as an example on how to create encrypted data bag items on your local file system: https://gist.github.com/2896172
