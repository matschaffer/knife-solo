...
The knife command for creating data bags doesn't work well in solo mode, so use this gist as an example on how to create encrypted data bag items: https://gist.github.com/2896172
